...
func exportJobs(jobs []types.Job, envIDToSlug map[string]string) []JobSpec {
...
func exportWorkflows(workflows []types.Workflow, steps map[string][]types.WorkflowStep, jobIDToSlug map[string]string) []WorkflowSpec {
...
func exportEnvironments(environments []types.Environment) []EnvironmentSpec {
